...
def render():
    ...
    with tab1:
        ...
        with col2:
            ...
            seg_stats["Avg_Income"] = seg_stats["Avg_Income"].apply(lambda x: f"Rs.{x:,.0f}")
            ...
            for seg, color in COLOR_MAP.items():
                ...
                if seg == "Safe":
                    fc = "rgba(72,187,120,0.13)"
                elif seg == "Risky":
                    fc = "rgba(246,173,85,0.13)"
                else:
                    fc = "rgba(252,129,129,0.13)"
    ...
    with tab2:
        ...
        corr_cols = [
            "credit_score", "income", "credit_utilization_ratio", "missed_payments",
    ...
    with tab3:
        ...
        with col2:
            ...
            fig_btd.update_layout(
                **PLOTLY_DARK,
                height=280,
                title="Time-to-Default Distribution (Defaulters)",
        ...
        with col3:
            fig_uti = px.box(
                df,
                x=df["defaulted"].map({0: "Non-Defaulter", 1: "Defaulter"}),
                y="credit_utilization_ratio",
            ...
            fig_uti.update_layout(
                **PLOTLY_DARK,
                height=280,
                title="Credit Utilization vs Default Status",
                margin=dict(l=10, r=10, t=40, b=10),
                showlegend=False,
            )
        ...
        with col4:
            ...
            fig_bal.update_layout(
                **PLOTLY_DARK,
                height=280,
                title="Balance Trend vs Default Probability",
                margin=dict(l=10, r=10, t=40, b=10),
                legend=dict(bgcolor="rgba(0,0,0,0)"),
            )
